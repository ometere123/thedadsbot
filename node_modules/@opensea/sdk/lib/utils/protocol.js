...
const VALID_PROTOCOL_ADDRESSES = new Set([
    (0, address_1.checksumAddress)(constants_1.CROSS_CHAIN_SEAPORT_V1_6_ADDRESS),
    (0, address_1.checksumAddress)(constants_2.ALTERNATE_SEAPORT_V1_6_ADDRESS),
]);
/**
...
const isValidProtocol = (protocolAddress) => {
    try {
        return VALID_PROTOCOL_ADDRESSES.has((0, address_1.checksumAddress)(protocolAddress));
    }
    catch {
        return false;
    }
