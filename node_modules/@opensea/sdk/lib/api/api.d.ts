...
export declare class OpenSeaAPI {
    ...
    readonly walletAuth: WalletAuthAPI;
    /**
     ...
     */
    generateFulfillmentData(fulfillerAddress: string, orderHash: string, protocolAddress: string, side: OrderSide, assetContractAddress?: string, tokenId?: string, unitsToFill?: string, recipientAddress?: string, includeOptionalCreatorFees?: boolean): Promise<Camelize<FulfillmentDataResponse>>;
    /**
     ...
     */
    getNFTsByCollection(slug: string, limit?: number | undefined, next?: string | undefined, traits?: TraitFilter[] | undefined): Promise<ListNFTsResponse>;
    /**
     ...
     */
    refreshNFTMetadata(address: string, identifier: string, chain?: Chain): Promise<Record<string, unknown>>;
    /**
     ...
     * @returns The {@link GetEventsResponse} returned by the API.
     */
    getEventsByCollection(collectionSlug: string, args?: GetEventsByCollectionArgs): Promise<GetEventsResponse>;
    /**
     ...
     */
    getTokenGroups(args?: GetTokenGroupsArgs): Promise<GetTokenGroupsResponse>;
    /**
     ...
     */
    getTokenGroup(slug: string): Promise<GetTokenGroupResponse>;
    /**
     ...
     * @returns The {@link GetOffersResponse} returned by the API.
     */
    getOffersByNFT(collectionSlug: string, identifier: string | number, limit?: number, next?: string): Promise<GetOffersResponse>;
    /**
     ...
     */
    executeSwap(request: SwapExecuteRequest): Promise<SwapExecuteResponse>;
    /**
     ...
     */
    getTransactionReceipt(request: TransactionReceiptRequest): Promise<TransactionReceiptResponse>;
    /**
     ...
     */
    buildCrossChainDropMintTransactions(slug: string, request: CrossChainDropMintRequest): Promise<CrossChainDropMintResponse>;
    /**
     ...
     */
    getAgentProfileRelationships(addressOrUsername: string): Promise<AgentProfileRelationshipsResponse>;
    /**
     ...
     * @returns The {@link OpenSeaCollection} returned by the API.
     */
    getNFTCollection(address: string, identifier: string, chain?: Chain): Promise<OpenSeaCollection>;
    /**
     ...
     */
    getNFTMetadata(address: string, tokenId: string, chain?: Chain): Promise<GetNFTMetadataResponse>;
    /**
     ...
     */
    getTokensBatch(request: BatchTokensRequest): Promise<TokenBatchResponse>;
    /**
     ...
     */
    getTokenPriceHistory(chain: Chain, address: string, args: TokenTimeSeriesArgs): Promise<PriceHistoryResponse>;
    /**
     ...
     */
    getTokenOhlcv(chain: Chain, address: string, args: TokenTimeSeriesArgs & {
        bucketSize: string;
    }): Promise<OhlcvResponse>;
    /**
     * Fetch recent swap activity for a token.
     */
    getTokenActivity(chain: Chain, address: string, args?: TokenActivityArgs): Promise<TokenSwapActivityPaginatedResponse>;
    /**
     * Fetch materialized trade count, USD volume, and average trade size for a
     * token across the requested windows.
     */
    getTokenActivityStats(chain: Chain, address: string, args?: TokenActivityStatsArgs): Promise<TokenActivityStatsResponse>;
    /**
     * Fetch paginated fungible token activity (transfers, swaps, wraps, and
     * unwraps) for an account across all chains.
     */
    getAccountTokenActivity(address: string, args?: GetAccountTokenActivityArgs): Promise<GetAccountTokenActivityResponse>;
    /**
     ...
     */
    getTokenHolders(chain: Chain, address: string, args?: TokenHoldersArgs): Promise<TokenHoldersResponse>;
    /**
     * Fetch liquidity pools for a token (pool type, USD reserves, and
     * bonding-curve progress / graduation flag where applicable).
     */
    getTokenLiquidityPools(chain: Chain, address: string, args?: TokenLiquidityPoolsArgs): Promise<TokenLiquidityPoolsResponse>;
    /**
     * Fetch multiple NFTs in a single request.
     */
    getNFTsBatch(request: BatchNftsRequest): Promise<NftBatchResponse>;
    /**
     * Fetch owners of an NFT.
     */
    getNFTOwners(address: string, identifier: string, chain?: Chain, args?: NFTOwnersArgs): Promise<OwnersPaginatedResponse>;
    /**
     * Fetch analytics (historical sale points) for an NFT.
     */
    getNFTAnalytics(address: string, identifier: string, chain?: Chain): Promise<NftAnalyticsResponse>;
    /**
     * Fetch multiple collections in a single request by slug.
     */
    getCollectionsBatch(request: BatchCollectionsRequest): Promise<CollectionBatchResponse>;
    /**
     * Fetch top offers for a collection grouped by price level.
     */
    getCollectionOfferAggregates(slug: string, args?: PaginatedAnalyticsArgs): Promise<CollectionOfferAggregatesPaginatedResponse>;
    /**
     * Fetch holders of a collection.
     */
    getCollectionHolders(slug: string, args?: CollectionHoldersArgs): Promise<CollectionHoldersPaginatedResponse>;
    /**
     * Fetch the floor-price history of a collection.
     */
    getCollectionFloorPrices(slug: string, args?: CollectionFloorPricesArgs): Promise<FloorPriceHistoryResponse>;
    /**
     ...
     */
    deployDropContract(request: DropDeployRequest): Promise<DropDeployResponse>;
    /**
     * Get the receipt of a previously submitted drop-deploy transaction.
     */
    getDeployContractReceipt(chain: Chain, txHash: string): Promise<DropDeployReceiptResponse>;
    /**
     * Build transactions to transfer NFTs or tokens between wallets.
     */
    transferAssets(request: TransferRequest): Promise<TransferResponse>;
    /**
     * Get portfolio stats (net worth, P&L) for an account.
     */
    getPortfolioStats(address: string, args?: PortfolioArgs): Promise<PortfolioStatsResponse>;
    /**
     * Get portfolio net-worth history for an account.
     */
    getPortfolioHistory(address: string, args?: PortfolioArgs): Promise<PortfolioHistoryResponse>;
    /**
     * Get offers received by an account.
     */
    getProfileOffersReceived(address: string, args?: ProfileOrdersArgs): Promise<ProfileOffersResponse>;
    /**
     * Get active offers made by an account.
     */
    getProfileOffers(address: string, args?: ProfileOrdersArgs): Promise<ProfileOffersResponse>;
    /**
     * Get active listings for an account.
     */
    getProfileListings(address: string, args?: ProfileOrdersArgs): Promise<ProfileListingsResponse>;
    /**
     * Get items favorited by an account.
     */
    getProfileFavorites(address: string, args?: ProfileFavoritesArgs): Promise<ProfileFavoritesResponse>;
    /**
     * Get collections owned by an account.
     */
    getProfileCollections(address: string, args?: ProfileCollectionsArgs): Promise<ProfileCollectionsResponse>;
    /**
     * Get aggregated trading P&L (realized + unrealized) for an account.
     */
    getWalletPnl(address: string): Promise<WalletPnlResponse>;
    /**
     * Get closed (realized) trading positions for an account.
     */
    getWalletClosedPositions(address: string, args?: WalletClosedPositionsArgs): Promise<ClosedPositionsResponse>;
    /**
     * Get the token transfers contributing to a wallet's position in a currency.
     */
    getWalletTokenTransfers(address: string, args: WalletTokenTransfersArgs): Promise<PositionTokenTransfersResponse>;
    /**
     ...
     */
    static requestInstantApiKey(apiBaseUrl?: string): Promise<RequestInstantApiKeyResponse>;
    /**
