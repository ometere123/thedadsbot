...
import { type DomainRegistry } from "./typechain-types/index";
import type { AdvancedOrder, CreateBulkOrdersAction, CreateOrderAction, CreateOrderInput, CriteriaResolver, ExchangeAction, InputCriteria, MatchOrdersFulfillment, Order, OrderComponents, OrderStatus, OrderUseCase, OrderWithCounter, SeaportConfig, SeaportContract, TipInputItem } from "./types";
import { type ContractMethodReturnType, type TransactionMethods } from "./utils/usecase";
export declare class Seaport {
     ...
     * @returns a use case containing the set of approval actions and fulfillment action
     */
    fulfillOrders({ fulfillOrderDetails, accountAddress, conduitKey, recipientAddress, domain, exactApproval, overrides, }: {
        fulfillOrderDetails: {
            order: OrderWithCounter;
            unitsToFill?: BigNumberish;
            offerCriteria?: InputCriteria[];
    ...
    matchAdvancedOrders({ orders, criteriaResolvers, fulfillments, recipient, overrides, accountAddress, domain, }: {
        ...
        accountAddress?: string;
        domain?: string;
    }): TransactionMethods<ContractMethodReturnType<SeaportContract, "matchAdvancedOrders">>;
    /**
