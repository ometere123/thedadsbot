...
class BaseOpenSeaSDK {
     ...
     */
    async validateOrderOnchain(orderComponents, accountAddress, protocolAddress) {
        return this._fulfillmentManager.validateOrderOnchain(orderComponents, accountAddress, protocolAddress);
    }
    /**
