...
exports.ZERO_CONDUIT_KEY = void 0;
exports.toBigInt = toBigInt;
exports.getErc20Payment = getErc20Payment;
exports.getFulfillerConduitKey = getFulfillerConduitKey;
exports.isZeroConduitKey = isZeroConduitKey;
...
exports.ZERO_CONDUIT_KEY = `0x${"0".repeat(64)}`;
/**
 ...
 */
function sumErc20Consideration(consideration) {
    if (!Array.isArray(consideration) || consideration.length === 0) {
        return null;
    }
    let token = null;
    let total = 0n;
    for (const rawItem of consideration) {
        if (!isRecord(rawItem)) {
            return null;
        }
 ...
 */
function basicOrderErc20Payment(basicOrderParameters) {
 ...
 */
function getErc20Payment(inputData) {
 ...
 */
function getFulfillerConduitKey(inputData) {
    if (!isRecord(inputData)) {
        return null;
    }
...
function isZeroConduitKey(conduitKey) {
    if (!conduitKey) {
        return true;
    }
    return conduitKey.toLowerCase() === exports.ZERO_CONDUIT_KEY;
}
//# sourceMappingURL=erc20Fulfillment.js.map