...
const records = [
  ...
  { key:'base', id:8453, name:'Base', currency:'ETH', explorer:'https://basescan.org', env:'BASE_RPCS', opensea:'base', defaultRpcs:['https://mainnet.base.org'] },
  { key:'robinhood', id:4663, name:'Robinhood Chain', currency:'ETH', explorer:'https://robinhoodchain.blockscout.com', env:'ROBINHOOD_RPCS', opensea:'robinhood', defaultRpcs:['https://rpc.mainnet.chain.robinhood.com'] },
  { key:'robinhood-testnet', id:46630, name:'Robinhood Chain Testnet', currency:'ETH', explorer:'https://explorer.testnet.chain.robinhood.com', env:'ROBINHOOD_TESTNET_RPCS', defaultRpcs:['https://rpc.testnet.chain.robinhood.com'] },
