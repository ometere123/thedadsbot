...
import type { CollectionOffer, Listing, Offer, Order, RequestInstantApiKeyResponse } from "../api/types";
import type { OrderV2 } from "../orders/types";
import type { ContractCaller, OpenSeaWallet } from "../provider/types";
import type { Amount, AssetWithTokenId, AssetWithTokenStandard, Chain, EventData } from "../types";
import { EventType } from "../types";
import { type BulkOrderResult } from "./orders";
/**
 ...
 */
export declare class BaseOpenSeaSDK {
     ...
     */
    getCrossChainFulfillmentData(options: {
        listings: Array<{
            hash: string;
            chain: string;
     ...
     */
    validateOrderOnchain(orderComponents: OrderComponents, accountAddress: string, protocolAddress?: string): Promise<string>;
    /**
     ...
     */
    createListingAndValidateOnchain(options: {
        asset: AssetWithTokenId;
        accountAddress: string;
        amount: Amount;
        quantity?: Amount;
     ...
     */
    createOfferAndValidateOnchain(options: {
        asset: AssetWithTokenId;
        accountAddress: string;
        amount: Amount;
        quantity?: Amount;
    ...
    offchainCancelOrder(protocolAddress: string, orderHash: string, chain?: Chain, offererSignature?: string, useSignerToDeriveOffererSignature?: boolean): Promise<{
