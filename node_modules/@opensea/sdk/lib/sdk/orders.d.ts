...
import type { CollectionOffer, Listing, Offer } from "../api/types";
import type { ProtocolData } from "../orders/types";
import { type Amount, type AssetWithTokenId, OrderSide } from "../types";
...
export declare class OrdersManager {
    ...
    constructor(context: SDKContext, getPriceParametersCallback: (orderSide: OrderSide, tokenAddress: string, amount: Amount) => Promise<{
        basePrice: bigint;
    }>);
